import fs from 'fs';
const content = `export const enhanceDetections = (items) => {
...
fs.writeFileSync('C:/Users/saran/OneDrive/Desktop/pragmatic_project/ballooning/frontend/src/utils/engineeringDetection.js', content);
console.log('Restored engineeringDetection.js');
